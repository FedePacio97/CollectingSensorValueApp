...
public class PreprocessingManager {
    ...
    public PreprocessingManager(Context context, int window, int period) {
        WINDOW = window;
    ...
    private void print_header(){
        String[] ATTRIBUTE_NAMES = {
                ...
                "rot_z_mean", "rot_z_median", "rot_z_95", "rot_z_max", "rot_z_min", "rot_z_range", "rot_z_std_dev", "rot_z_rms", "rot_z_dom_freq", "rot_z_dom_freq_2"
        };
